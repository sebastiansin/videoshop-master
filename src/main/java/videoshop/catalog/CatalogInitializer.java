...
class CatalogInitializer implements DataInitializer {
	...
	public void initialize() {
		...
		videoCatalog.save(new Disc("Persepolis", "pers", Money.of(14.99, EURO), "Animation/Biography/Drama",
				DiscType.DVD, 0, Money.of(14.99, EURO)));
		videoCatalog.save(new Disc("Hot Shots! Part Deux", "hspd", Money.of(9999.0, EURO), "Action/Comedy/War",
				DiscType.DVD, 0, Money.of(9999.0, EURO)));
		videoCatalog.save(new Disc("Avatar: The Last Airbender", "tla", Money.of(19.99, EURO),
				"Animation/Action/Adventure", DiscType.DVD, 0, Money.of(50, EURO)));
		...
		videoCatalog.save(new Disc("The Godfather", "tg", Money.of(19.99, EURO), "Crime/Drama", DiscType.BLURAY, 0,
				Money.of(50, EURO)));
		videoCatalog.save(new Disc("No Retreat, No Surrender", "nrns", Money.of(29.99, EURO), "Martial Arts",
				DiscType.BLURAY, 0, Money.of(50, EURO)));
		videoCatalog.save(new Disc("The Princess Bride", "tpb", Money.of(39.99, EURO), "Adventure/Comedy/Family",
				DiscType.BLURAY, 0, Money.of(50, EURO)));
		videoCatalog.save(new Disc("Top Secret!", "ts", Money.of(39.99, EURO), "Comedy", DiscType.BLURAY, 0,
				Money.of(50, EURO)));
		videoCatalog.save(new Disc("The Iron Giant", "tig", Money.of(34.99, EURO), "Animation/Action/Adventure",
				DiscType.BLURAY, 0, Money.of(50, EURO)));
		videoCatalog.save(new Disc("Battle Royale", "br", Money.of(19.99, EURO), "Action/Drama/Thriller",
				DiscType.BLURAY, 0, Money.of(50, EURO)));
