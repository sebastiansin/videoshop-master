...
[[1. GUI Startseite (allgemein)_image]]
image::.\GUI_digitalisiert\1. GUI Startseite (allgemein).png[Landing page, 100%, 100%, pdfwidth=100%, title= "Landing page of {project_name}", align=center]
