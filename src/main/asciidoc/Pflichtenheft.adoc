...
[[1_GUI_Startseite_(allgemein)_image]]
image::.\GUI_digitalisiert\1_GUI_(allgemein).png[Landing page, 100%, 100%, pdfwidth=100%, title= "Landing page of {project_name}", align=center]
