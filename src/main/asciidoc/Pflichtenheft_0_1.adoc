...
|Chef (Admin) | Registrierter Nutzer mit Administrationsrechten zu Erstellung und Bearbeitungeitung der Artikel und Bearbeitung von Mitarbeiter Accounts.
|==============
